...
import hamburgerIcon from "../../assets/images/icons/hamburger2.png";
import calenderIcon from "../../assets/images/icons/calendar2.png";
import databaseIcon from "../../assets/images/icons/database.png";
import bellhornIcon from "../../assets/images/icons/bellhorn.png";
...
const ContentIconSideNav = () => {
  return (
    <div className="icons-side-nav overflow-hidden d-flex py-4 flex-column gap-2 align-items-center px-1 py-3 bg-white border-end min-vh-100 max-height-100vh">
      {/* Meta logo */}
      <span className="px-1">
        <img
          className="w-100"
      ...
      {/* Portgrand logo */}
      <span className="px-1">
        <span className="border p-2 rounded-3 mt-3 w-100 h-auto d-flex justify-content-center align-items-center">
          <img
      ...
      <div className="d-flex gap-3 flex-column align-items-center mt-4">
        <span>
          <img src={homeIcon} alt="homeIcon" className="side-nav-icon" />
        </span>
        <span>
        ...
        <span>
          <img src={windowscon} alt="windowscon" className="rounded-3" />
        </span>
        <span>
          <img
            src={bellhornIcon}
...
export default ContentIconSideNav;
