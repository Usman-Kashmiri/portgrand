  ...
  return (
    <div style={{ display: "flex" }}>
      <div className="sidebarmaindiv">
        ...
        <div>
          {/* <img src={metaimg} className='metasideimage'/> */}
          <div className="metaimgandtextdiv">
            <img
              className="metaimg"
            ...
            />
            <p>
              Meta <br /> Bussiness Suite
            </p>
          </div>
          <div
            className="dropdownportgrand d-flex align-items-center cursor-pointer"
            onClick={() => navigate("/")}
          >
            <img
              ...
              alt="portgrand logo"
            />
            <span className="font-poppins">Port Grand Pakistan</span>
          </div>
          {sideNav.map((value, key) => {
            const isActive = window.location.pathname === value.path;
            const activeClass = isActive ? "navlinkdivactive" : "navlinkdiv";
            return (
              <div className={activeClass} key={key}>
                <Link to={value.path} className="sidebarnavlinks">
                  {value.icon}
                  {/* <p> */}
