...
const Content = () => {
      ...
      <Container className="content-container py-4 px-5 d-flex flex-column w-100" fluid>
        <Grid className="justify-content-between">
            ...
            <Grid.Col span={4} className="d-flex justify-content-end align-items-center gap-2">
                ...
                <div class="dropdown">
  <button class="btn createdropdown dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    Create
  </button>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      <button className="accordion-button contentdropsmainbtn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        <img width={25}  className="contentdropimg" src={contentdrop}/>
        Content
      </button>
    </h2>
      ...
      <div class="accordion-body">
        {
          Contentdrops.map((value , key)=>{
            ...
            const activeClass = isActive ? 'contentdropsdivactiv' : 'contentdropsdiv';
            return(
              <div className={activeClass}>

              <Link to={value.path} key={key} className={activeClass}>
              {value.name}
              </Link>
              {/* <br /> */}
              </div>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      ...
      <img width={25}  className="contentdropimg" src={collectiondrop}/>
        Collections
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header">
      ...
      <img width={25}  className="contentdropimg" src={createdrop}/>
       Creative a...
      </button>
    </h2>
...
<div className="contenttabs">
  ...
  <p>Expired</p> */}
  {
    contenetabslinkarray.map((value , key)=>{
      ...
      return(
        <p key={key} id={value} className={secopmnavactiv == value ? 'contentabslinksactiv' : 'contentabslinks'} onClick={activnav}>{value}</p>
...
<Dropdown >
      <Dropdown.Toggle className="contentdropdowns" variant="light" id="dropdown-basic">
        Post type
      </Dropdown.Toggle>
